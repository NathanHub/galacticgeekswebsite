        ...
        function o(n, r, i) {
            ...
            if ("undefined" != typeof document) {
                if (arguments.length > 1) {
                    ...
                    r = t.write ? t.write(r, n) : encodeURIComponent(String(r)).replace(/%(23|24|26|2B|3A|3C|3E|3D|2F|3F|40|5B|5D|5E|60|7B|7D|7C)/g, decodeURIComponent),
                ...
                for (var p = document.cookie ? document.cookie.split("; ") : [], d = /(%[0-9A-Z]{2})+/g, l = 0; l < p.length; l++) {
                    ...
                    try {
                        ...
                        if (m = t.read ? t.read(m, C) : t(m, C) || m.replace(d, decodeURIComponent),
                            this.json)
                            try {
                                m = JSON.parse(m)
                            } catch (s) { }
...
!function (t, s) {
    ...
    "use strict";
    var t, s, n = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, i = /^(-|\+)?P(?:([-+]?[0-9,.]*)Y)?(?:([-+]?[0-9,.]*)M)?(?:([-+]?[0-9,.]*)W)?(?:([-+]?[0-9,.]*)D)?(?:T(?:([-+]?[0-9,.]*)H)?(?:([-+]?[0-9,.]*)M)?(?:([-+]?[0-9,.]*)S)?)?$/, e = {
        years: 31536e6,
        months: 2592e6,
        days: 864e5,
        hours: 36e5,
        ...
        return c.calMilliseconds = function () {
            ...
            c.get = function (t) {
                var s = this.$ms
                    , n = u(t);
                return "milliseconds" === n ? s %= 1e3 : s = "weeks" === n ? a(s / e[n]) : this.$d[n],
                    0 === s ? 0 : s
            }
            ,
            c.add = function (t, s, n) {
                var i;
                return i = s ? t * e[u(s)] : r(t) ? t.$ms : o(t, this).$ms,
